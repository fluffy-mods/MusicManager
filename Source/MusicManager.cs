...
namespace MusicManager
{
    ...
    {
        private static MethodInfo _appropriateNowMethodInfo;
        private static AccessTools.FieldRef<MusicManagerPlay, AudioSource> _audioSourceRef;
        private static AccessTools.FieldRef<MusicManagerPlay, SongDef> _lastStartedSongRef;
        ...
        public static SongDef CurrentSong
        {
            get
            {
                if (!AudioSource?.isPlaying ?? true && !isPaused) return null;
                return _lastStartedSongRef(Find.MusicManagerPlay);
            }
        }
