...
![Compatibility with other mods](https://headers.karel-kroeze.nl/title/Compatibility%20with%20other%20mods.png)  

Music Manager is fully compatible with other mods that add music to the game.

![Coming Soon](https://headers.karel-kroeze.nl/title/Coming%20Soon.png)  
